...
classifier = Sequential() #object bana rahe hai yaha bas
...
classifier.add(Dense(units=32,activation = 'relu')) #unit specipfy number of node, ye baad me accuracy badhane ke kaam aaye gaa
...
# Total 5 layer hai hidden layer me

classifier.add(Dense(units=6,activation = 'softmax')) #unit 6 ka matlab hai ki total 6 output hai
